...
export const CalenderIcon = (props: JSX.IntrinsicElements['svg']) => (
  <svg
...
export const IssueIcon = (props: JSX.IntrinsicElements['svg']) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const AtIcon = (props: JSX.IntrinsicElements['svg']) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const GithubIcon = (props: JSX.IntrinsicElements['svg']) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1rem" height="1rem" {...props}>
...
export const BlueskyIcon = (props: JSX.IntrinsicElements['svg']) => (
  <svg
    stroke="currentColor"
    fill="currentColor"
    stroke-width="0"
